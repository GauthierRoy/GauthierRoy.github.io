...
{% assign desired_order = "modernpatentbert,backdooring-agent,pytorch-journey,deepip-patent-ai,llm-ranking-framework,ml-toolkit-exploration,lingua-custodia-pipelines,hackathon-language-assistant" | split: ',' %}
